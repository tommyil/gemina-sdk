...
/**
 * CheckoutOutDTO Class Doc Comment
 *
 * @category Class
 * @package  Gemina\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CheckoutOutDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CheckoutOutDTO';
    ...
    public const STATUS_CHECKOUT_READY = 'checkout_ready';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('status', $data ?? [], 'checkout_ready');
