...
/**
 * CreditTransactionListOutDTO Class Doc Comment
 *
 * @category Class
 * @package  Gemina\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreditTransactionListOutDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreditTransactionListOutDTO';
    ...
    protected static $openAPITypes = [
        ...
        'total' => 'int',
        'transactions' => '\Gemina\Sdk\Model\CreditTransactionOutDTO[]'
    ];
     ...
     * Sets total
     *
     * @param int|null $total Total number of transactions matching the filter, across all pages. Clients can use this to render 'Page X of Y' without a second count call. Scoped to the same ``meter`` filter as ``transactions`` when one is applied.
     *
     * @return self
     */
     ...
     * Gets transactions
     *
     * @return \Gemina\Sdk\Model\CreditTransactionOutDTO[]
     */
     ...
     * Sets transactions
     *
     * @param \Gemina\Sdk\Model\CreditTransactionOutDTO[] $transactions transactions
     *
     * @return self
     */
