...
/**
 * RetrievalStatusOutDTO Class Doc Comment
 *
 * @category Class
 * @description Per-tenant snapshot of the document index.
 * @package  Gemina\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RetrievalStatusOutDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RetrievalStatusOutDTO';
    ...
    protected static $setters = [
        ...
        'indexed_documents' => 'setIndexedDocuments',
    ...
    protected static $getters = [
        ...
        'indexed_documents' => 'getIndexedDocuments',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('indexed_documents', $data ?? [], 0);
    ...
    /**
     * Gets indexed_documents
     *
     * @return int|null
     */
    public function getIndexedDocuments()
    {
        return $this->container['indexed_documents'];
    }

    /**
     * Sets indexed_documents
     *
     * @param int|null $indexed_documents indexed_documents
     *
     * @return self
     */
    public function setIndexedDocuments($indexed_documents)
    {
        if (is_null($indexed_documents)) {
            throw new \InvalidArgumentException('non-nullable indexed_documents cannot be null');
        }
        $this->container['indexed_documents'] = $indexed_documents;
