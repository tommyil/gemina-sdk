...
/**
 * ChatTranscriptOutDTO Class Doc Comment
 *
 * @category Class
 * @package  Gemina\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ChatTranscriptOutDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ChatTranscriptOutDTO';
    ...
    protected static $openAPITypes = [
        ...
        'messages' => '\Gemina\Sdk\Model\ChatMessageOutDTO[]',
        'served_at' => '\DateTime',
        'served_at_timestamp' => 'float',
        'session' => '\Gemina\Sdk\Model\ChatSessionOutDTO'
    ];
     ...
     * Sets count
     *
     * @param int $count Total messages in the session, not just this page
     *
     * @return self
     */
     ...
     * Gets messages
     *
     * @return \Gemina\Sdk\Model\ChatMessageOutDTO[]
     */
     ...
     * Sets messages
     *
     * @param \Gemina\Sdk\Model\ChatMessageOutDTO[] $messages messages
     *
     * @return self
     */
     ...
     * Gets session
     *
     * @return \Gemina\Sdk\Model\ChatSessionOutDTO
     */
     ...
     * Sets session
     *
     * @param \Gemina\Sdk\Model\ChatSessionOutDTO $session session
     *
     * @return self
     */
