...
/**
 * PlanDetailOutDTO Class Doc Comment
 *
 * @category Class
 * @package  Gemina\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PlanDetailOutDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PlanDetailOutDTO';
    ...
    protected static $openAPITypes = [
        ...
        'credit_costs' => '\Gemina\Sdk\Model\PlanCreditCostOutDTO[]',
        'credits' => 'int',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('credit_costs', $data ?? [], null);
     ...
     * Gets credit_costs
     *
     * @return \Gemina\Sdk\Model\PlanCreditCostOutDTO[]|null
     */
    public function getCreditCosts()
    {
        return $this->container['credit_costs'];
    }

    /**
     * Sets credit_costs
     *
     * @param \Gemina\Sdk\Model\PlanCreditCostOutDTO[]|null $credit_costs credit_costs
     *
     * @return self
     */
    public function setCreditCosts($credit_costs)
    {
        if (is_null($credit_costs)) {
            throw new \InvalidArgumentException('non-nullable credit_costs cannot be null');
        }
        $this->container['credit_costs'] = $credit_costs;
