...
public class ContractOutDTO {
  ...
  public static final String SERIALIZED_NAME_MONTHLY_SPEND_LIMIT_CENTS = "monthlySpendLimitCents";
  @SerializedName(SERIALIZED_NAME_MONTHLY_SPEND_LIMIT_CENTS)
  @javax.annotation.Nullable
  private Integer monthlySpendLimitCents;
  ...
  public ContractOutDTO monthlySpendLimitCents(@javax.annotation.Nullable Integer monthlySpendLimitCents) {
    this.monthlySpendLimitCents = monthlySpendLimitCents;
    return this;
  }

  /**
   * Get monthlySpendLimitCents
   * @return monthlySpendLimitCents
   */
  @javax.annotation.Nullable
  public Integer getMonthlySpendLimitCents() {
    return monthlySpendLimitCents;
  }

  public void setMonthlySpendLimitCents(@javax.annotation.Nullable Integer monthlySpendLimitCents) {
    this.monthlySpendLimitCents = monthlySpendLimitCents;
  }
   ...
   * @return the ContractOutDTO instance itself
   */
  public ContractOutDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billingCycleDay, contractOutDTO.billingCycleDay) &&
        ...
        Objects.equals(this.monthlySpendLimitCents, contractOutDTO.monthlySpendLimitCents) &&
        ...
        Objects.equals(this.additionalProperties, contractOutDTO.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingCycleDay, chatIncludedPerCycle, chatPriceCents, checkoutUrl, createdAt, createdAtTimestamp, documentIntelligenceEnabled, id, indexPriceCents, maxMonthlyExtractions, monthlyFiletagCredits, monthlySpendLimitCents, paddleSubscriptionId, rateCardTemplateId, rateCards, requiresManualApproval, retrievalRateLimitPerSecond, status, storageIncludedGb, storagePricePerGbMonthCents, userEmail, userId, volumeDiscountTiers, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    monthlySpendLimitCents: ").append(toIndentedString(monthlySpendLimitCents)).append("\n");
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractOutDTO>() {
           ...
           public ContractOutDTO read(JsonReader in) throws IOException {
             ...
             ContractOutDTO instance = thisAdapter.fromJsonTree(jsonObj);
