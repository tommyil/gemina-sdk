...
import co.gemina.sdk.generated.model.ValueAnyOfInner;
...
public class Value extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final Type typeInstanceListValueAnyOfInner = new TypeToken<List<ValueAnyOfInner>>(){}.getType();
            final TypeAdapter<List<ValueAnyOfInner>> adapterListValueAnyOfInner = (TypeAdapter<List<ValueAnyOfInner>>) gson.getDelegateAdapter(this, TypeToken.get(typeInstanceListValueAnyOfInner));
            ...
            return (TypeAdapter<T>) new TypeAdapter<Value>() {
                ...
                public void write(JsonWriter out, Value value) throws IOException {
                    ...
                    // check if the actual instance is of the type `List<ValueAnyOfInner>`
                    if (value.getActualInstance() instanceof List<?>) {
                        List<?> list = (List<?>) value.getActualInstance();
                        if (!list.isEmpty() && list.get(0) instanceof ValueAnyOfInner) {
                            JsonArray array = adapterListValueAnyOfInner.toJsonTree((List<ValueAnyOfInner>)value.getActualInstance()).getAsJsonArray();
                            elementAdapter.write(out, array);
                            return;
                        }
                    }
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: BigDecimal, Boolean, Integer, List<ValueAnyOfInner>, String");
                }
                ...
                public Value read(JsonReader in) throws IOException {
                    ...
                    // deserialize List<ValueAnyOfInner>
                    try {
                        // validate the JSON object to see if any exception is thrown
                        ...
                        for(JsonElement element : array) {
                            ValueAnyOfInner.validateJsonElement(element);
                        }
                        actualAdapter = adapterListValueAnyOfInner;
                        Value ret = new Value();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for List<ValueAnyOfInner> failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'List<ValueAnyOfInner>'", e);
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for Value: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    static {
        ...
        schemas.put("List<ValueAnyOfInner>", List.class);
    }
     ...
     * BigDecimal, Boolean, Integer, List&lt;ValueAnyOfInner&gt;, String
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be BigDecimal, Boolean, Integer, List<ValueAnyOfInner>, String");
    }
     ...
     * BigDecimal, Boolean, Integer, List&lt;ValueAnyOfInner&gt;, String
     *
     * @return The actual instance (BigDecimal, Boolean, Integer, List&lt;ValueAnyOfInner&gt;, String)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `List&lt;ValueAnyOfInner&gt;`. If the actual instance is not `List&lt;ValueAnyOfInner&gt;`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `List&lt;ValueAnyOfInner&gt;`
     * @throws ClassCastException if the instance is not `List&lt;ValueAnyOfInner&gt;`
     */
    public List<ValueAnyOfInner> getListValueAnyOfInner() throws ClassCastException {
        return (List<ValueAnyOfInner>)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with List<ValueAnyOfInner>
        try {
            if (!jsonElement.isJsonArray()) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected json element to be a array type in the JSON string but got `%s`", jsonElement.toString()));
            }
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for Value with anyOf schemas: BigDecimal, Boolean, Integer, List<ValueAnyOfInner>, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
