...
public class ValuesValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ValuesValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ValuesValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ValuesValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ValuesValue>() {
                @Override
                public void write(JsonWriter out, ValuesValue value) throws IOException {
                ...
                @Override
                public ValuesValue read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ValuesValue ret = new ValuesValue();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ValuesValue: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ValuesValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ValuesValue with anyOf schemas: BigDecimal, Integer. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of ValuesValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ValuesValue
     * @throws IOException if the JSON string is invalid with respect to ValuesValue
     */
    public static ValuesValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ValuesValue.class);
    }

    /**
     * Convert an instance of ValuesValue to an JSON string
     *
     * @return JSON string
     */
