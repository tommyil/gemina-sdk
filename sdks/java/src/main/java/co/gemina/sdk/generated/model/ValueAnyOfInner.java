...
public class ValueAnyOfInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ValueAnyOfInner.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ValueAnyOfInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ValueAnyOfInner' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ValueAnyOfInner>() {
                @Override
                public void write(JsonWriter out, ValueAnyOfInner value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: BigDecimal, Integer, String");
                }

                @Override
                public ValueAnyOfInner read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ValueAnyOfInner ret = new ValueAnyOfInner();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ValueAnyOfInner: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ValueAnyOfInner() {
        super("anyOf", Boolean.FALSE);
    }

    public ValueAnyOfInner(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ValueAnyOfInner.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ValueAnyOfInner
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ValueAnyOfInner with anyOf schemas: BigDecimal, Integer, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of ValueAnyOfInner given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ValueAnyOfInner
     * @throws IOException if the JSON string is invalid with respect to ValueAnyOfInner
     */
    public static ValueAnyOfInner fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ValueAnyOfInner.class);
    }

    /**
     * Convert an instance of ValueAnyOfInner to an JSON string
     *
     * @return JSON string
     */
