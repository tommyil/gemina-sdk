...
class ContractOutDTO(BaseModel):
    ...
    monthly_spend_limit_cents: Optional[StrictInt] = Field(default=None, alias="monthlySpendLimitCents")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if monthly_spend_limit_cents (nullable) is None
        # and model_fields_set contains the field
        if self.monthly_spend_limit_cents is None and "monthly_spend_limit_cents" in self.model_fields_set:
            _dict['monthlySpendLimitCents'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monthlySpendLimitCents": obj.get("monthlySpendLimitCents"),
