...
class PlanDetailOutDTO(BaseModel):
    """
    PlanDetailOutDTO
    """ # noqa: E501
    ...
    credit_costs: Optional[List[PlanCreditCostOutDTO]] = Field(default=None, alias="creditCosts")
    credits: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlanDetailOutDTO from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in credit_costs (list)
        _items = []
        if self.credit_costs:
            for _item_credit_costs in self.credit_costs:
                if _item_credit_costs:
                    _items.append(_item_credit_costs.to_dict())
            _dict['creditCosts'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlanDetailOutDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "creditCosts": [PlanCreditCostOutDTO.from_dict(_item) for _item in obj["creditCosts"]] if obj.get("creditCosts") is not None else None,
